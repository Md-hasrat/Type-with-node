...
import { adminLoginSchema, adminLogoutSchema, adminRegisterSchema } from "../zodSchema/adminSchema"
...
export const logoutAdmin =asyncHandler(async (req: Request, res: Response) => {
    ...
    return responseHandler(res, true, "Admin logged out successfully", 200) 
})